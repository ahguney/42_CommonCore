...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/25 18:14:13 by ahguney           #+#    #+#             */
/*   Updated: 2023/09/26 15:44:54 by ahguney          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Pmerge::result(void)
{
    ...
    for (size_t i = 0; i < _sortedVector.size(); i++)
		...
		std::cout << std::endl;
	std::cout << "Time to process a range of  " << _input.size() << " elements with std::vector : " << elapsedTime << " us" ;
    ...
    // }
	std::cout << std::endl;
	std::cout << "Time to process a range of  " << _input.size() << " elements with std::deque : " << elapsedTime << " us" << std::endl;
}